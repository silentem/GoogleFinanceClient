...
public class BarData implements Serializable {
    ...
    public BarData( GregorianCalendar dateTime, double open, double high, double low, double close) {
     ...
     */
    public BarData(GregorianCalendar dateTime, double open, double high, double low, double close, long openInterest) {
        this(dateTime, open, high, low, close);
